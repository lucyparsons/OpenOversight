...
def upgrade():
    ...
    op.execute(
        """
            UPDATE assignments
            SET last_updated_at=date_updated
    ...
    with op.batch_alter_table("incidents", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("last_updated_by", sa.Integer(), nullable=True))
        batch_op.create_foreign_key(
            "incidents_last_updated_by_users_fkey",
            "users",
            ["last_updated_by"],
            ["id"],
            ondelete="SET NULL",
    ...
    op.execute(
        """
            UPDATE incidents
            SET last_updated_by=last_updated_id
...
def downgrade():
    with op.batch_alter_table("unit_types", schema=None) as batch_op:
        batch_op.drop_constraint(
            "unit_types_last_updated_by_users_fkey", type_="foreignkey"
        )
    ...
    with op.batch_alter_table("salaries", schema=None) as batch_op:
        batch_op.drop_constraint(
            "salaries_last_updated_by_users_fkey", type_="foreignkey"
        )
        batch_op.drop_column("last_updated_by")
        batch_op.drop_column("last_updated_at")
    ...
    with op.batch_alter_table("raw_images", schema=None) as batch_op:
        batch_op.drop_constraint(
            "raw_images_last_updated_by_users_fkey", type_="foreignkey"
        )
    ...
    op.execute(
        """
            UPDATE officers
            SET date_updated=last_updated_at
    ...
    with op.batch_alter_table("officers", schema=None) as batch_op:
        batch_op.drop_constraint(
            "officers_last_updated_by_users_fkey", type_="foreignkey"
        )
        batch_op.drop_column("last_updated_by")
        batch_op.drop_column("last_updated_at")
    ...
    with op.batch_alter_table("locations", schema=None) as batch_op:
        batch_op.drop_constraint(
            "locations_last_updated_by_users_fkey", type_="foreignkey"
        )
        batch_op.drop_column("last_updated_by")
        batch_op.drop_column("last_updated_at")
    ...
    with op.batch_alter_table("incidents", schema=None) as batch_op:
        batch_op.add_column(sa.Column("date_updated", sa.DateTime(), nullable=True))
        batch_op.add_column(sa.Column("last_updated_id", sa.Integer(), nullable=True))
    ...
    op.execute(
        """
            UPDATE incidents
            SET last_updated_id=last_updated_by
    ...
    with op.batch_alter_table("incidents", schema=None) as batch_op:
        batch_op.drop_constraint(
            "incidents_last_updated_by_users_fkey", type_="foreignkey"
        )
        batch_op.drop_column("last_updated_by")
        batch_op.drop_column("last_updated_at")
