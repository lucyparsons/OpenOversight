...
def upgrade():
    ...
    op.add_column('officers', sa.Column('unique_internal_identifier', sa.String(length=50), nullable=True))
    op.create_index(op.f('ix_officers_unique_internal_identifier'), 'officers', ['unique_internal_identifier'], unique=True)
