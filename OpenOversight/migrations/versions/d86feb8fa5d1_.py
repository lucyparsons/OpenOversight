...
def upgrade():
    ...
    op.create_index(op.f('ix_license_plates_number'), 'license_plates', ['number'], unique=False)
    op.create_index(op.f('ix_license_plates_state'), 'license_plates', ['state'], unique=False)
    ...
    op.create_index(op.f('ix_locations_street_name'), 'locations', ['street_name'], unique=False)
    op.create_index(op.f('ix_locations_zip_code'), 'locations', ['zip_code'], unique=False)
    ...
    sa.ForeignKeyConstraint(['address_id'], ['locations.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_incidents_date'), 'incidents', ['date'], unique=False)
    op.create_index(op.f('ix_incidents_report_number'), 'incidents', ['report_number'], unique=False)
    op.create_table('incident_license_plates',
    sa.Column('incident_id', sa.Integer(), nullable=False),
    sa.Column('link_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['incident_id'], ['incidents.id'], ),
    sa.ForeignKeyConstraint(['link_id'], ['license_plates.id'], ),
    ...
    op.create_table('officer_incidents',
