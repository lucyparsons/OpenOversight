...
Revision ID: b429700e2dd2
Revises: 18f43ac4622f
Create Date: 2023-08-01 17:25:38.181437
...
def upgrade():
    ...
    with op.batch_alter_table('assignments', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('assignments_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('departments', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('departments_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('descriptions', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('descriptions_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('faces', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('faces_created_by_fkey', 'users', ['created_by'], ['id'])
    ...
    with op.batch_alter_table('incidents', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('incidents_last_updated_by_fkey', 'users', ['last_updated_by'], ['id'],
                                    ondelete='SET NULL')
        batch_op.create_foreign_key('incidents_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('jobs', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('jobs_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('license_plates', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('license_plates_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('links', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('links_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('locations', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('locations_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')

    with op.batch_alter_table('notes', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.drop_constraint('notes_creator_id_fkey', type_='foreignkey')
        batch_op.create_foreign_key('notes_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('officers', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('officers_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('raw_images', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('raw_images_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('salaries', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('salaries_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('unit_types', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('unit_types_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('created_at', sa.DateTime(timezone=True),
                                      server_default=sa.text('now()'), nullable=False))
        batch_op.add_column(sa.Column('created_by', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('users_created_by_fkey', 'users', ['created_by'], ['id'],
                                    ondelete='SET NULL')
...
def downgrade():
    ...
    with op.batch_alter_table('raw_images', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('raw_images_user_id_fkey', 'users', ['user_id'],
                                    ['id'])
    ...
    with op.batch_alter_table('notes', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('notes_creator_id_fkey', 'users', ['creator_id'],
    ...
    with op.batch_alter_table('links', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('links_creator_id_fkey', 'users', ['creator_id'],
                                    ['id'], ondelete='SET NULL')
    ...
    with op.batch_alter_table('incidents', schema=None) as batch_op:
        batch_op.add_column(
            sa.Column('last_updated_id', sa.INTEGER(), autoincrement=False,
                      nullable=True))
        batch_op.add_column(
            sa.Column('creator_id', sa.INTEGER(), autoincrement=False, nullable=True))
        ...
        batch_op.create_foreign_key('incidents_creator_id_fkey', 'users',
                                    ['creator_id'], ['id'])
        batch_op.create_foreign_key('incidents_last_updated_id_fkey', 'users',
                                    ['last_updated_id'], ['id'])
    ...
    with op.batch_alter_table('descriptions', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('descriptions_creator_id_fkey', 'users',
