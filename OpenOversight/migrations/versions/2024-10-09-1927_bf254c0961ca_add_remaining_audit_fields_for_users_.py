...
def upgrade():
    with op.batch_alter_table('users', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('users_confirmed_by_fkey', 'users', ['confirmed_by'], ['id'], ondelete='SET NULL')
        batch_op.create_foreign_key('users_disabled_by_fkey', 'users', ['disabled_by'], ['id'], ondelete='SET NULL')
        batch_op.create_foreign_key('users_approved_by_fkey', 'users', ['approved_by'], ['id'], ondelete='SET NULL')
