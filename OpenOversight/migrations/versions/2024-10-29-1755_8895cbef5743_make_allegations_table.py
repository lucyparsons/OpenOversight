...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['created_by'], ['users.id'], name='allegations_created_by_fkey', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['incident_id'], ['incidents.id'], name='allegations_incident_id_fkey'),
    sa.ForeignKeyConstraint(['last_updated_by'], ['users.id'], name='allegations_last_updated_by_fkey', ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['officer_id'], ['officers.id'], name='allegations_officer_id_fkey'),
