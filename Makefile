...
db_diagram:
	...
	eralchemy2 -i postgresql://openoversight:terriblepassword@postgres:5432/openoversight-dev -o database/schema.new.md
	...
	@if diff schema.md.sorted schema.new.md.sorted > /dev/null 2>&1; then \
		...
		eralchemy2 -i postgresql://openoversight:terriblepassword@postgres:5432/openoversight-dev -o database/schema.dot; \
